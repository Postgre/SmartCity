package com.smartcity.yx.session;
...
import com.smartcity.yx.session.action.AVChatAction;
import com.smartcity.yx.session.action.FileAction;
import com.smartcity.yx.session.action.GuessAction;
import com.smartcity.yx.session.action.RTSAction;
import com.smartcity.yx.session.action.SnapChatAction;
import com.smartcity.yx.session.activity.MessageHistoryActivity;
import com.smartcity.yx.session.activity.MessageInfoActivity;
import com.smartcity.yx.session.extension.CustomAttachParser;
import com.smartcity.yx.session.extension.CustomAttachment;
...
import com.smartcity.yx.session.search.SearchMessageActivity;
import com.smartcity.yx.session.viewholder.MsgViewHolderAVChat;
import com.smartcity.yx.session.viewholder.MsgViewHolderDefCustom;
import com.smartcity.yx.session.viewholder.MsgViewHolderFile;
import com.smartcity.yx.session.viewholder.MsgViewHolderGuess;
import com.smartcity.yx.session.viewholder.MsgViewHolderRTS;
import com.smartcity.yx.session.viewholder.MsgViewHolderSnapChat;
import com.smartcity.yx.session.viewholder.MsgViewHolderSticker;
import com.smartcity.yx.session.viewholder.MsgViewHolderTip;

...
public class RoundProgressBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		case STROKE:{
			...
			canvas.drawArc(oval, from, 360 * progress / max, false, paint);  //���ݽ��Ȼ�Բ��
			break;
		}
		...
		case FILL:{
			...
			if(progress !=0)
				canvas.drawArc(oval, from, 360 * progress / max, true, paint);  //���ݽ��Ȼ�Բ��
			break;
		}
		}
	 ...
	 * @param progress
	 */
	public synchronized void setProgress(int from ,int progress) {
		if(progress < 0){

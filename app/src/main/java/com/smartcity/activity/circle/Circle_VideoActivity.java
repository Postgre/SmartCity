...
public class Circle_VideoActivity extends BaseActivity implements
	...
	private void initNet() {
		...
		service.getCircleVideo(MyApplication.getApikey(), Url.CIRCLEVIDEO, Constant.VALUE_VERSION, GsonUtils.objectToJson(maps)).enqueue(new Callback<CircleVideo>() {
			@Override
			public void onResponse(Response<CircleVideo> response, Retrofit retrofit) {

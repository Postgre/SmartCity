...
//		maps.put("detailCircleId", "4");
		...
		service.getCircleNotice(MyApplication.getApikey(), Url.CIRCLENOTICE, Constant.VALUE_VERSION, GsonUtils.objectToJson(maps)).enqueue(new Callback<CircleNotice>() {
			@Override
			public void onResponse(Response<CircleNotice> response, Retrofit retrofit) {

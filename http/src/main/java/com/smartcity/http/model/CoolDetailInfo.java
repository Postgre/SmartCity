 ...
 */
public class CoolDetailInfo extends BaseModel {
    ...
    private CoolDetailItemInfo data;

    public CoolDetailItemInfo getData() {
        return data;
    }

    public void setData(CoolDetailItemInfo data) {
        this.data = data;
    }

    public static class CoolDetailItemInfo {
        private int coolId;
        ...
        public int getIIsATed() {
            return iIsATed;
        }

        public void setIIsATed(int iIsATed) {
        ...
        public static class MPlmapBean {
            ...
            public List<CommentInfo> getNewestCommentList() {
                return newestCommentList;
            }

            public void setNewestCommentList(List<CommentInfo> newestCommentList) {
